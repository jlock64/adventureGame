...
var answer = prompt("Are you ready to go on a safari? Type yes or no. If you'd rather play some trivia, type trivia.");
    ...
    answer = prompt("What animals are you hoping to see most? Lions,  elephants or giraffes?");
     ...
     //ANSWER EQUALS LIONS//
       ...
       answer = prompt("Let me test your elephant knowledge. How much can an average elephant heart weigh? 27 pounds or 46 pounds?");
        if (answer === 27 || 27 + " pounds") {
          confirm("Nope. An average elephant heart can weigh up to 47 pounds! That's a big heart throb!");
        }
        else if (answer === 46 || 46 + " pounds") {
  ...
  /////////////////////START DRINKING GAME///////////////////////
      ...
      if (answer === "yes") {
        ...
        // BEER CHOICE //
        if (answer = "beer") {
          confirm("I love beer too! Be careful not to drink too much oryou will get a beer belly. Hairy beer bellies aren'tpretty.");
          answer = prompt("Do you prefer IPA's or stouts?");
          if (answer = "IPAs") {
            confirm("That's what I'm talking about! UnfortunatelIPAs average 240 calories per beer. Guess we will starworking on our big hairy bellies together.");
          }
...
////////////////// UNKNOWN INPUT ON SAFARI QUESTION ////////////////
      ...
      lotteryTrivia();
      if (answer === "gain weight" || "get fat" || "get fatter") {
        ...
        if (answer === "gain weight" || "get fat" || "get fatter") {
          ...
          confirm("Sorry, wrong again. Next question.");
        }
      }
